// Databricks notebook source exported at Wed, 17 Feb 2016 05:39:18 UTC
...
// MAGIC 
// MAGIC ![equation](http://i.imgur.com/C3ANtrZ.png)
// MAGIC 
// MAGIC where _a_ is the intercept and _b_ are coefficients.
// MAGIC 
...
// MAGIC %md We'll stop here, but you can read on, later, for more information.
